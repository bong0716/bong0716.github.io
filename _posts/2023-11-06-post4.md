...
Hash는 List의 한계를 극복하며 저장 또는 검색 등에서 자주 활용되는 자료구조다.   
...
### HashSet  
**value를** 자바에서 **자동으로 임의 지정**하며 **key의 중복을 배제**하고 값을 넣는다.    
...
### HashMap  
**key와 value를 개발자가 직접 기입**하고 **key의 중복을 배제**한다.  
